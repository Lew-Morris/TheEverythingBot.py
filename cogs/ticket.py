...
class ticket(commands.Cog):
    ...
    async def createticket(self, ctx, *args):
        ...
        ticket_embed=discord.Embed(title="Ticket tool", description="This is the ticket tool, by reacting to this message, the Bot will create a private channel where you can gain assistance from admins", color=0xFF5733)
        ticket_embed.set_image(url="https://www.pngitem.com/pimgs/m/521-5213418_vector-free-download-svg-support-sales-support-icon.png")
                ...
                if user_channel_id in items:
                    ...
                    if guild_roles is None:
                        ...
                        await create_channel.send(
                            f'{new_user_role.mention} Your ticket has been created! Please use this time to explain your situation that requires an  '
                            f'{admin_role.mention} to help. They will be here shortly!')
